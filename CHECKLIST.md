...
- [x] Phase 6 — frontend: brutalist-lite landing + shadcn/ui dashboard (light/dark), live FTSO price, honest empty states; Servo's own frontend deployed at servo-cyan.vercel.app (legacy, untouched); https://servo-dashboard.vercel.app was created as Servo's new deployment 2026-08-07 but per owner decision now serves the Kairos frontend (kzs `apps/frontend`); dashboard → landing link; no mock data
