...
- [x] Phase 6 — frontend: brutalist-lite landing + shadcn/ui dashboard (light/dark), live FTSO price, honest empty states; deployed at servo-cyan.vercel.app (legacy) + new production deployment https://servo-dashboard.vercel.app (2026-08-07, project `servo-dashboard`, live on-chain reads verified); dashboard → landing link; no mock data
